...
module.exports = class CommonTargetCommand extends Command {
    constructor(client) {
        super(client, {
            name: 'fullcommontarget',
            aliases: ['fullct', 'fullctp', 'fullct%', 'fct', 'fctp'],
            group: 'target',
            memberName: 'fullcommontarget',
            description: 'This command shows the most common targets for a specific team',
            args: [
                {
                    key: 'team',
